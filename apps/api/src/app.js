...
const teamPublicRoutes = require('./modules/teams/team-public.routes');
const playerPublicRoutes = require('./modules/players/player-public.routes');
const organizationPublicRoutes = require('./modules/organizations/organization-public.routes');
const seasonPublicRoutes = require('./modules/seasons/season-public.routes');
const mediaPublicRoutes = require('./modules/media/media-public.routes');
...
app.use('/api/public/competitions', competitionPublicRoutes);
app.use('/api/public/teams', teamPublicRoutes);
app.use('/api/public/players', playerPublicRoutes);
app.use('/api/public/organizations', organizationPublicRoutes);
app.use('/api/public/seasons', seasonPublicRoutes);
app.use('/api/public/media', mediaPublicRoutes);
